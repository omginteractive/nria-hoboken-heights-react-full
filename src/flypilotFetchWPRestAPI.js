const flypilotFetchWPRestAPI = async (endpoint) => {
    ...
    ,{
        ...
        headerTheme: 'dark',
        enableScrolling: true,
        availabilityHeadline: result.heading_availability,
        availabilityText: result.content_availability,
        availabilityFloorplansLabel: result.drop_down_1_label,
        availabilityFloorplansOptions: result.drop_down_1,
        availabilityCollectionLabel: result.drop_down_2_label,
        availabilityCollectionOptions: result.drop_down_2,
