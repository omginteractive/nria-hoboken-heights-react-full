		...
		return(
            <div className={mobileMenuClasses}>
                ...
                <div className="mobileMenuContact">
                    ...
                    <div className="address">1300 Manhattan Avenue Union City, NJ 07087 <br class='line-break' /><span className="separator">|</span> Manhattan Avenue Capital 1300, LLC<br />Richard Stabile | RE/MAX Real Estate Limited | <span className='phoneNum'><a href='tel:2014007487'>201-400-7487</a></span></div>
